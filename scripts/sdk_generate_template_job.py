...
from _sdk_sql import get_warehouse_id
        ...
        "datasets": [
            {
                ...
                "queryLines": [
                    ...
                    "  CAST(prod_category_id AS STRING) AS category_id,",
                ...
                "layout": [
                    {
                        "widget": {
                            ...
                            "spec": {
                                ...
                                "encodings": {"fields": [{"parameterName": "date_range", "queryName": "q_date"}]},
...
def main():
    ...
    parser.add_argument(
        "--warehouse-name",
        default=None,
        help="SQL warehouse name for the AI/BI dashboard (required when multiple warehouses exist)",
    )
    ...
    profile = "dev" if env == "dev" else env
    ws = WorkspaceClient(profile=profile)
    warehouse_id = get_warehouse_id(ws, name=args.warehouse_name)
        ...
        "resources": {
            ...
            "dashboards": {
                "orders_dashboard": {
                    ...
                    "file_path": "resources/orders_dashboard.lvdash.json",
